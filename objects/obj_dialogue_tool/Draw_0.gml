...
draw_formatted_text(face ? text_x_with_face : text_x, text_y, format_basic, wrap_formatted_text(text, face ? 25 : 32, true));
...
draw_formatted_text(x_big + 7, 271, format_bubble, "{c,bk}" + wrap_formatted_text(text, width_big, false));
...
draw_formatted_text(x_small + 65, 271, format_bubble, "{c,bk}" + wrap_formatted_text(text, width_small, false));
draw_formatted_text(x_small, pixel_height_small + 261, format_bubble, "Small bubble\n(for random encounters)");

draw_set_color(c_gray);
draw_set_font(fnt_small);
draw_set_halign(fa_center);
draw_text(320, 458, "UNDERTALE DIALOGUE TOOL v1.01 (C) PYTHON-B5 2024");
